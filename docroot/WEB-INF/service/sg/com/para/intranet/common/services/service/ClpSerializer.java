...
import sg.com.para.intranet.common.services.model.AttachmentClp;
import sg.com.para.intranet.common.services.model.EmployeeClp;
import sg.com.para.intranet.common.services.model.ProjectClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"intranet-common-service-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "intranet-common-service-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"sg.com.para.intranet.common.services.model.impl.AttachmentImpl")) {
		...
		if (oldModelClassName.equals(
					"sg.com.para.intranet.common.services.model.impl.EmployeeImpl")) {
		...
		if (oldModelClassName.equals(
					"sg.com.para.intranet.common.services.model.impl.ProjectImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new sg.com.para.intranet.common.services.NoSuchAttachmentException();
		}

		if (className.equals(
					"sg.com.para.intranet.common.services.NoSuchEmployeeException")) {
			return new sg.com.para.intranet.common.services.NoSuchEmployeeException();
		}

		if (className.equals(
					"sg.com.para.intranet.common.services.NoSuchProjectException")) {
			return new sg.com.para.intranet.common.services.NoSuchProjectException();
		}
