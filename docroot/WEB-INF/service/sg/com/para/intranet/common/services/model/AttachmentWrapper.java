...
public class AttachmentWrapper implements Attachment, ModelWrapper<Attachment> {
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<sg.com.para.intranet.common.services.model.Attachment> toCacheModel() {
		return _attachment.toCacheModel();
	}

	@Override
	public sg.com.para.intranet.common.services.model.Attachment toEscapedModel() {
		return new AttachmentWrapper(_attachment.toEscapedModel());
	}

	@Override
	public sg.com.para.intranet.common.services.model.Attachment toUnescapedModel() {
