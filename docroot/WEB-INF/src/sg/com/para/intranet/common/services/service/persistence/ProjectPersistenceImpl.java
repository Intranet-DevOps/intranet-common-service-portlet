...
import sg.com.para.intranet.common.services.NoSuchProjectException;
import sg.com.para.intranet.common.services.model.Project;
import sg.com.para.intranet.common.services.model.impl.ProjectImpl;
import sg.com.para.intranet.common.services.model.impl.ProjectModelImpl;
...
public class ProjectPersistenceImpl extends BasePersistenceImpl<Project>
	 ...
	 */
	@Override
	public Project create(int projectId) {
	...
	protected Project toUnwrappedModel(Project project) {
		...
		projectImpl.setCode(project.getCode());
	 ...
	 */
	@Override
	public Project findByPrimaryKey(int projectId)
		throws NoSuchProjectException, SystemException {
	 ...
	 */
	@Override
	public Project fetchByPrimaryKey(int projectId) throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.sg.com.para.intranet.common.services.model.Project")));
